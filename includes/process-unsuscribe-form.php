...
if( is_email ( $wp_great_newsletter_email ) ) {
	...
	$user_count = $wpdb->get_var( "SELECT COUNT(*) FROM " . $wpdb->prefix . "great_newsletter WHERE email='".$wp_great_newsletter_email."'" );
	  ...
	  $result = "wpgn_email_unsb_exist";
		...
		$wpdb->delete( $wpdb->prefix . "great_newsletter", array( 
